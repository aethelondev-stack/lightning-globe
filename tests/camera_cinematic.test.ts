...
test('EventDirector - Filters candidate clusters according to CameraFilterMatrix', () => {
  ...
  const clusterTurkey: ScoredCluster = {
    ...
    strikesPerMinute: 30,
    growthRate: 1.0,
    breakdown: { rateScore: 0.8, growthScore: 0.5, energyScore: 0.7, clusterSizeScore: 0.9 },
    events: [],
    activityScore: 0.85,
  ...
  const clusterUS: ScoredCluster = {
    ...
    strikesPerMinute: 45,
    growthRate: 1.0,
    breakdown: { rateScore: 0.9, growthScore: 0.6, energyScore: 0.8, clusterSizeScore: 0.95 },
    events: [],
    activityScore: 0.90,
