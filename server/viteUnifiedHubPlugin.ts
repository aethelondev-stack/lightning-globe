...
export function viteUnifiedHubPlugin(): Plugin {
  return {
    ...
    configureServer(server: ViteDevServer) {
      ...
      server.middlewares.use('/api/lightning/stream', (req, res) => {
        res.writeHead(200, {
      ...
      server.middlewares.use('/api/lightning/history-24h', (req, res) => {
      ...
      server.middlewares.use('/api/lightning/stats', (_req, res) => {
